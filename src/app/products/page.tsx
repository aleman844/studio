  ...
  return (
    <div className="container mx-auto px-4 py-12 md:px-6 md:py-20">
      <section className="text-center mb-16">
        <h1 className="text-4xl md:text-6xl font-bold font-headline mb-4">Our Arsenal</h1>
        <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto">
          Explore our range of pre-configured systems and individual components. Every product is selected and tested for maximum performance and reliability.
        </p>
      </section>
      ...
      <section>
        <h2 className="text-3xl font-bold font-headline mb-8">Computer Parts</h2>
        ...
        <div className="text-center mt-8">
          <Link href="/contact">
            <Button size="lg">Request a Custom Part List</Button>
          </Link>
        </div>
      </section>
    </div>
